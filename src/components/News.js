...
export default class News extends Component {
  ...
  static propTypes = {
    ...
    constructor(props) {
        ...
        document.title = `NewsToU - ${this.capitalizeFirstLetter(this.props.category)}`;
    }
    ...
    async updateNews() {
      ...
      const url = `https://newsapi.org/v2/top-headlines?country=${this.props.contentCountry}&category=${this.props.category}&apikey=${this.props.apiKey}&page=${this.state.page}&pageSize=${this.props.pageSize}`;
  ...
  render() {
    return (
      <>
        <h1 className='text-center' style={{marginTop: '70px', marginBottom: '40px'}}>NewsToU - Top {this.capitalizeFirstLetter(this.props.category)}  Headlines</h1>
